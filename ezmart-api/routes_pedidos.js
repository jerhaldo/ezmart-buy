...
router.get('/:id', (req, res)=>{
    const {id} = req.params;
    let sql = 'select prod.id_prod as id,nombre_prod,nombre_categ,desc_prod,precio_prod_act,precio_prod_ant,stock_prod,cant_ventas,oferta,estado,nombre_multi\
